public class PageLocators {
    // Локаторы для страницы DNS-Shop.ru
    ...
    String characteristicField =
            "//a[@class='product-card-tabs__title ui-link ui-link_black' and contains(text(),'Характеристики')]";
    String tableRamLeft =
            "//table[@class='table-params table-no-bordered']/descendant-or-self::*[text()=' 8 Гб']";
    String tableRam =
            "//table[@class='table-params table-no-bordered']/descendant-or-self::*[text()=' Объем оперативной памяти ']";
}
